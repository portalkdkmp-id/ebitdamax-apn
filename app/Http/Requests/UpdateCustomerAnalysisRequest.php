...
class UpdateCustomerAnalysisRequest extends FormRequest
{
    /**
    ...
    {
        $customerAnalysis = $this->route('customer_analysis');

        return $customerAnalysis instanceof CustomerAnalysis
            && $this->user()?->can('update', $customerAnalysis) === true;
    }
